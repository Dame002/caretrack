...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "CareTrack: système intelligent de triage et de suivi en temps réel des urgences médicales." },
      { name: "author", content: "Mama Atta Ndao — ISI" },
      { property: "og:title", content: "CareTrack — Urgences Médicales" },
      { property: "og:description", content: "Triage intelligent, suivi temps réel, parcours patient maîtrisé." },
